...
const APP_SETTING_KEYS: readonly string[] = [
  ...
  'showPinnedUserMessage', 'autoRecap', 'toolGroupCards', 'autoExpandRunningGroups', 'showMessageHeaders', 'rowGap', 'textSpacing', 'fontSize', 'appToolsGit', 'firstPartyTools', 'allowSensitivePathEdits',
]
