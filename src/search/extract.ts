...
import { flattenHast, type HastNode } from './hast-walk'
 ...
 *
 *  Per the design decision: only `text`-typed content blocks
...
export function extractMessagePlainText(msg: SdkMessage): string | null {
