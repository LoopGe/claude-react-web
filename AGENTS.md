...
- `git-status-changed` — per-session signal that the worktree may have changed (debounced, fired after Codex's mutating tools land); clients refetch their own status / branches / stashes / session-files
